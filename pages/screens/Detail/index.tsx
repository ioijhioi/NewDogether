            ...
            <SafeArea>
                <SafeAreaTop>
                    <Header>
                        {/* <TouchableOpacity onPressOut={() => navigation.navigate('Calendar')}> */}
                            <Button
                                source={require("../../../public/images/List/calendar.png")}
                            />
                        {/* </TouchableOpacity> */}
                        <HeaderTitle>11/1의 두게더</HeaderTitle>
                        <Button2 source={require("../../../public/images/List/calendar.png")}/>
                        <Button source={require("../../../public/images/List/calendar.png")}/>
                    </Header>
                    <Body>
                        <BodyTop>
                ...
                <Footer>
                    <InnerFooter> 
                        ...
                        />
                        <SendIcon source={require("../../../public/images/List/calendar.png")}/>
                    </InnerFooter>
                </Footer>
            </SafeArea>
        </>
